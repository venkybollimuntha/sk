...
#     for stack in stack_dict[761:800]:
#         try:
#             c+=1
...
#                                     profile_exist = False
#                                     role_exist = False
#                                 with open("ec2-prod-4.csv", "a") as file:
...
#             with open("ec2-exception-file-prod-4.csv", "a") as exception_file:
...
# c = 80
# for account in accounts[80:100]:
#     c=c+1
#     try:
